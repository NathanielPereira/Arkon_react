  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 py-16 md:py-24 bg-transparent">
      ...
      <div className="w-full max-w-3xl bg-white/70 rounded-2xl shadow-xl border border-azulClaro/40 p-10 md:p-14 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl">
        <svg width="48" height="48" fill="none" stroke="#2563EB" strokeWidth="2.5" viewBox="0 0 24 24" className="mb-4 drop-shadow-md"><path d="M21 10V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v3" /><rect x="3" y="10" width="18" height="11" rx="2" /></svg>
        ...
        <div className="w-full flex flex-col gap-8 items-center">
          ...
          >
            ...
            <textarea name="descricao" placeholder="Como podemos ajudar?" required className="p-3 rounded border border-azulFuturo bg-white text-azulFuturo placeholder:text-azulFuturo/70 focus:ring-2 focus:ring-ciano transition-all duration-200"></textarea>
            <button type="submit" className="bg-ciano hover:bg-azulFuturo text-black px-8 py-3 font-bold text-lg rounded-full shadow-lg transition-all duration-300 scale-100 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-ciano">Enviar</button>
          </form>
        </div>
      </div>
    </section>
