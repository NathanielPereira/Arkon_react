  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-start px-4 pt-16 md:pt-20 pb-12 md:pb-16 bg-transparent">
      ...
      <div className="max-w-2xl w-full text-center mb-8">
        <h1 className="text-lg md:text-xl font-medium mb-4 text-azulFuturo" style={{ letterSpacing: 0.2 }}>Quem Somos</h1>
      ...
      <div className="w-full flex flex-col items-center">
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            <p className="text-base text-center transition-all duration-300 group-hover:text-azulFuturo max-w-2xl mx-auto" style={{ color: AZUL_ESCURO }}>
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            ...
            <h2 className="text-lg font-bold mb-2 text-azulFuturo transition-all duration-300 group-hover:text-azulRoyal text-center">Missão</h2>
            <p className="text-base text-center transition-all duration-300 group-hover:text-azulFuturo max-w-2xl mx-auto" style={{ color: AZUL_ESCURO }}>Impulsionar empresas com tecnologia, criatividade e atendimento humano.</p>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            ...
            <h2 className="text-lg font-bold mb-2 text-ciano transition-all duration-300 group-hover:text-azulFuturo text-center">Visão</h2>
            <p className="text-base text-center transition-all duration-300 group-hover:text-azulFuturo max-w-2xl mx-auto" style={{ color: AZUL_ESCURO }}>Ser referência em soluções digitais que inspiram e transformam negócios.</p>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            ...
            <h2 className="text-lg font-bold mb-2 text-azulRoyal transition-all duration-300 group-hover:text-ciano text-center">Valores</h2>
            <p className="text-base text-center transition-all duration-300 group-hover:text-azulFuturo max-w-2xl mx-auto" style={{ color: AZUL_ESCURO }}>Ética, inovação, parceria, excelência e foco genuíno no cliente.</p>
          </div>
        </div>
