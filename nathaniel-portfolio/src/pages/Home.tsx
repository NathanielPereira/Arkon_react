  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-start px-4 pt-16 md:pt-20 pb-12 md:pb-16 bg-transparent">
      ...
      <div className="max-w-2xl w-full text-center mb-8">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4 text-center" style={{ color: AZUL_ESCURO, letterSpacing: 0.5 }}>Tecnologia que Impulsiona o Seu Negócio</h1>
        <h2 className="text-xl md:text-2xl font-semibold mb-6 text-azulFuturo text-center" style={{ letterSpacing: 0.2 }}>Soluções digitais criativas para empresas que querem crescer de verdade.</h2>
      ...
      <div className="w-full flex flex-col items-center">
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            ...
            <h3 className="text-lg font-bold mb-2 text-azulFuturo transition-all duration-300 group-hover:text-azulRoyal text-center">Soluções Sob Medida</h3>
            <p className="text-base text-center transition-all duration-300 group-hover:text-azulFuturo max-w-2xl mx-auto" style={{ color: AZUL_ESCURO }}>Desenvolvimento de sistemas, apps e sites personalizados para o seu negócio.</p>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            ...
            <h3 className="text-lg font-bold mb-2 text-ciano transition-all duration-300 group-hover:text-azulFuturo text-center">Atendimento Consultivo</h3>
            <p className="text-base text-center transition-all duration-300 group-hover:text-azulFuturo max-w-2xl mx-auto" style={{ color: AZUL_ESCURO }}>Acompanhamento próximo, transparência e parceria em cada etapa do projeto.</p>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            ...
            <h3 className="text-lg font-bold mb-2 text-azulRoyal transition-all duration-300 group-hover:text-ciano text-center">Design & Performance</h3>
            <p className="text-base text-center transition-all duration-300 group-hover:text-azulFuturo max-w-2xl mx-auto" style={{ color: AZUL_ESCURO }}>Visual moderno, navegação intuitiva e foco total em resultados para sua empresa.</p>
          </div>
        </div>
