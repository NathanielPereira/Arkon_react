      ...
      <div className="w-full flex flex-col items-center">
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            ...
            <h3 className="text-lg font-bold mb-2 text-azulFuturo transition-all duration-300 group-hover:text-azulRoyal">Soluções Sob Medida</h3>
            <p className="text-base text-center transition-all duration-300 group-hover:text-azulFuturo" style={{ color: AZUL_ESCURO }}>Desenvolvimento de sistemas, apps e sites personalizados para o seu negócio.</p>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            ...
            <h3 className="text-lg font-bold mb-2 text-ciano transition-all duration-300 group-hover:text-azulFuturo">Atendimento Consultivo</h3>
            <p className="text-base transition-all duration-300 group-hover:text-azulFuturo" style={{ color: AZUL_ESCURO }}>Acompanhamento próximo, transparência e parceria em cada etapa do projeto.</p>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center px-4 md:px-8">
          ...
          >
            ...
            <h3 className="text-lg font-bold mb-2 text-azulRoyal transition-all duration-300 group-hover:text-ciano">Design & Performance</h3>
            <p className="text-base transition-all duration-300 group-hover:text-azulFuturo" style={{ color: AZUL_ESCURO }}>Visual moderno, navegação intuitiva e foco total em resultados para sua empresa.</p>
          </div>
        </div>
