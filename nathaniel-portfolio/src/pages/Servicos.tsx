    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-4 py-12 md:py-16 bg-transparent">
      ...
      <div className="w-full max-w-5xl flex flex-col items-center">
        ...
        <div className="bg-white/70 rounded-2xl shadow-xl border border-azulClaro/40 p-8 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl mb-8">
          ...
          <p className="text-base text-center" style={{ color: AZUL_ESCURO }}>Desenvolvemos sites institucionais, landing pages e portais que traduzem a essência da sua marca, com design moderno, performance e foco em conversão.</p>
        </div>
        <div className="w-full h-[1.5px] bg-gray-200 my-12" />
        <div className="bg-white/70 rounded-2xl shadow-xl border border-azulClaro/40 p-8 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl mb-8">
          ...
          <p className="text-base text-center" style={{ color: AZUL_ESCURO }}>Criamos sistemas sob medida e aplicativos inovadores, integrando tecnologia, usabilidade e segurança para transformar processos e potencializar resultados.</p>
        </div>
        <div className="w-full h-[1.5px] bg-gray-200 my-12" />
        <div className="bg-white/70 rounded-2xl shadow-xl border border-azulClaro/40 p-8 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl mb-8">
          ...
          <p className="text-base text-center" style={{ color: AZUL_ESCURO }}>Apoiamos sua empresa em toda a jornada digital, com consultoria estratégica, UX/UI e transformação digital para impulsionar o crescimento sustentável.</p>
        </div>
        <div className="w-full h-[1.5px] bg-gray-200 my-12" />
      </div>
    </section>
